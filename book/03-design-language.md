...
timeline
    ...
    1940s-1950s : Swiss / International Typographic Style
                : Grid, sans-serif, photography, claimed objectivity
    1960s-1970s : Corporate modernism becomes the default
                : Universality starts to look like uniformity
    1970s-1990s : Postmodern reaction
                : Plurality, irony, quotation, broken grids
    1990s-2000s : Digital experimentation then web standards
                : Screens make type flexible and layout fluid
    2010s : Flat design and system fonts
          : Swiss logic returns as the interface default
    2020s : Both at once
          : Brutalism, maximalism, and grids coexisting
```
