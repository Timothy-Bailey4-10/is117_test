...
```mermaid
flowchart TD
    P[Product<br/>the same white shirt]
    A[Audience<br/>who we are talking to]
    M[Meaning / Archetype<br/>who they get to become]
    R[Persuasion<br/>what response we enable]
    V[Visual Language<br/>how it looks and feels]
    ...
    S -->|evidence feeds back| M
    F -->|evidence feeds back| M
```
